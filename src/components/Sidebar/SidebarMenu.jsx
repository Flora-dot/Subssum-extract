            ...
            >
              <g clipPath="url(#clip0_2095_396)">
                <path
                  ...
                  className={`${
                    activeMenu === "Dashboard" ? "fill-custom-white" : "fill-[#6882B6]"
                  }`}
                />
              </g>
              <defs>
        ...
        >
          <div className="flex gap-3 items-center text-xl font-medium">
            ...
            >
              <path
                ...
                className={`${
                  activeMenu === "Buy Airtime" ? "fill-custom-white" : "fill-[#6882B6]"
                }`}
              />
            </svg>
            <p>Buy Airtime</p>
          ...
          >
            <path
              ...
              className={`${
                activeMenu === "Buy Airtime" ? "stroke-custom-white" : "stroke-[#6882B6]"
              }`}
              strokeWidth="1.5"
              strokeLinecap="round"
          ...
          <div className="flex gap-3 items-center text-xl font-medium">
            ...
            >
              <path
                ...
                className={`${
                  activeMenu === "Buy Data" ? "stroke-custom-white" : "stroke-[#6882B6]"
                }`}
                strokeWidth="2"
                strokeLinecap="round"
                strokeLinejoin="round"
          ...
          <div className="flex gap-3 items-center text-xl font-medium">
            ...
            >
              <path
                ...
                className={`${
                  activeMenu === "Tv Subscription" ? "stroke-custom-white" : "stroke-[#6882B6]"
                }`}
                stroke="#6882B6"
                stroke-width="2"
          ...
          <div className="flex gap-3 items-center text-xl font-medium">
            ...
            >
              <path
                ...
                className={`${
                  activeMenu === "Pay Bill" ? "stroke-custom-white" : "stroke-[#6882B6]"
                }`}
                stroke="#6882B6"
                stroke-width="2"
                stroke-linecap="round"
          ...
          <div className="flex gap-3 items-center text-xl font-medium">
            ...
            >
              <path
                ...
                className={`${
                  activeMenu === "Airtime to cash" ? "stroke-custom-white" : "stroke-[#6882B6]"
                }`}
                stroke="#6882B6"
                stroke-width="2"
                stroke-linecap="round"
          ...
          <div className="flex gap-3 items-center text-xl font-medium">
            ...
            >
              <path
                ...
                className={`${
                  activeMenu === "Transaction History" ? "stroke-custom-white" : "stroke-[#6882B6]"
                }`}
                stroke="white"
                stroke-width="2"
                stroke-linecap="round"
          ...
          <div className="flex gap-3 items-center text-xl font-medium">
            ...
            >
              <path
                ...
                className={`${
                  activeMenu === "Help & Support" ? "stroke-custom-white" : "stroke-[#6882B6]"
                }`}
                stroke="#6882B6"
                stroke-width="2"
                stroke-linecap="round"
...
export const Logout = () => {
  ...
  return (
    <Link to="/login">
      <div className="w-full flex gap-3 items-center text-xl mt-14 font-medium py-3 pl-2 pr-12 rounded-xl hover:bg-custom-grey-70 hover:text-custom-white" onClick={handleLogout}>
