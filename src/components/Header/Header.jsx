...
export const HeaderSignedIn = () => {
  return (
    <header className="flex items-center justify-between">
      <p className="font-medium text-xl leading-5 text-custom-grey-90">Welcome, Lawal Wahab</p>
      <div  className="flex items-center gap-3">
        <Link to='/upgrade' className='font-semibold text-base text-custom-primary-blue'>Upgrade To Merchant</Link>
        <CustomButton>
          <svg
            width="16"
            height="16"
