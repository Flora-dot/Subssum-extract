...
export const TotalReferrals = () => {
  ...
  return (
    <div className=" p-6 rounded-2xl border-2 border-custom-grey-30 w-full">
      <div className="flex justify-between">
        <div>
          <p className="text-base font-normal text-custom-grey-90 font-sans">
            Total referrals made
          </p>
          <h6 className="font-semibold text-2xl text-custom-grey-90 mt-1">
            {totalReferrals}
          </h6>
        </div>
        <div>
